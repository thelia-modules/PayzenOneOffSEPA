...
class PayzenOneOffSEPA extends Payzen
{
    ...
    const WAITING_MESSAGE_NAME = 'payzen_sepa_payment_waiting';
    const CONFIRMATION_MESSAGE_NAME = 'payzen_sepa_payment_confirmation';
    ...
    public function postActivation(ConnectionInterface $con = null)
    {
        ...
        if (null === MessageQuery::create()->findOneByName(self::WAITING_MESSAGE_NAME)) {
            $message = new Message();

            $message
                ->setName(self::WAITING_MESSAGE_NAME)
